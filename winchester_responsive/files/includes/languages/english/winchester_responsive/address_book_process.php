...
define('HEADING_TITLE_ADD_ENTRY', 'New Address');
define('HEADING_TITLE_MODIFY_ENTRY', 'Update Address Book');
define('HEADING_TITLE_DELETE_ENTRY', 'Delete Address');
...
define('NEW_ADDRESS_TITLE', 'New Address');
