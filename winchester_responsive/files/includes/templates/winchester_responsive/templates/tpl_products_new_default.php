...
<?php
if (TEMPLATE_DEBUG == 'True') echo '\includes\templates\TEMPLATE\templates\tpl_products_new_default.php<br />then requires tpl_modules_listing_display_order.php<br />then tpl_modules_product_listing.php<br /><br />';//STEVE
